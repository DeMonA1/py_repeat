...
class SendMoreMoney2(Chromosome):
    ...
    def mutate(self) -> None:           # swap two letters
        idx1, idx2 = sample(range(len(self.letters)), k=2)
...
if __name__ == '__main__':
    ...
    ga: GeneticAlgorithm[SendMoreMoney2] = GeneticAlgorithm(initial_population=
                    initial_population, threshold=1.0, max_generations=1000,
