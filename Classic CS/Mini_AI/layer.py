...
class Layer:
    def __init__(self, previous_layer: Optional[Layer], num_neurons: int,
        ...
        # then there may be one large list inclusion
    ...
    # called inlt for the ouput layer
    def calculate_deltas_for_ouput_layer(self, expected: List[float]) -> None:
    ...
    # not called for the ouput layer
