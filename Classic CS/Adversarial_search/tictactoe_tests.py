...
class TTTMinimaxTestCase(unittest.TestCase):
    def test_easy_position(self):
        # winning in one move
        to_win_easy_position: List[TTTPiece] = [TTTPiece.X, TTTPiece.O, TTTPiece.X, TTTPiece.X,
                                                TTTPiece.E, TTTPiece.O, TTTPiece.E, TTTPiece.E,
                                                TTTPiece.O]
    ...
    def test_block_position(self):
        # it's necessary to prevent the opponent from winning
        to_block_position: List[TTTPiece] = [TTTPiece.X, TTTPiece.E, TTTPiece.E, TTTPiece.E,
                                             TTTPiece.E, TTTPiece.O, TTTPiece.E, TTTPiece.X,
                                             TTTPiece.O]
    ...
    def test_hard_position(self):
        # find the best turn to win in 2 turns
        to_win_hard_position: List[TTTPiece] = [TTTPiece.X, TTTPiece.E, TTTPiece.E, TTTPiece.E,
                                                TTTPiece.E, TTTPiece.O, TTTPiece.O, TTTPiece.X,
                                                TTTPiece.E]
